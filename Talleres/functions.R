...
my_EDA <- function(x, dec = 2, trim = 0.1) {
  ...
  par(mfrow = c(2, 2))
  par(mar = c(5, 4, 2, 1))
  hist(x, freq = FALSE, col = Adkblue, xlab = "", ylab = "", 
  ...
  plot(density(x), xlab = "", ylab = "", axes = FALSE, type = "n", 
  ...
  axis(side = 2)
  box()
  mtext("ANÁLISIS EXPLORATORIO DE DATOS", side = 3, outer = TRUE, 
